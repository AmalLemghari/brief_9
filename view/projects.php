        ...
        <aside class="md:inset-y-0 md:left-0 md:bg-white md:shadow-md md:h-screen md:w-60">
            <div class="flex flex-col justify-between h-full">
                <div class="flex-grow top-0">
                    ...
                    <h1 class="text-xl font-bold leading-none"><span class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">Task Manager</span> 2.0</h1>
                    </div>
                    <div class="p-4">
                        <ul class="space-y-1">
                            <li>
                                <a href="dashboard.php" class="flex bg-white hover:bg-green-50 rounded-xl font-bold text-sm text-gray-900 py-3 px-4">
                            ...
                            <li>
                                <a href="projects.php" class="flex items-center bg-green-200 rounded-xl font-bold text-sm text-black-900 py-3 px-4">
                                <svg class="h-7" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <section class="flex flex-wrap mt-20 mx-auto md:px-12 flex-grow">
                ...
                <div class="relative p-4 w-full max-w-md max-h-full">
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <form class="p-4 md:p-5" action="" method="post">
                            ...
                            <button type="submit" name="addpro" class="inline-flex items-center bg-green-100 hover:bg-green-200 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            ...
            <div class="container mx-auto px-4 md:px-12">
                <div class="flex justify-center bg-white rounded-xl p-2 w-40 mb-5 shadow-lg">
                    <h2 class="text-lg">All projects</h2>
                </div>
                <!-- Create Project Card -->
                <div class="my-1 px-1 w-full md:h-48 md:w-1/2 lg:my-4 lg:px-2 lg:w-1/4">

    <!-- Article -->
    <article class="overflow-hidden rounded-lg shadow-lg">
        <div class="group bg-green-50 py-8 px-2 flex flex-col space-y-2 items-center cursor-pointer rounded-md">
            <a data-modal-target="crud-modal" data-modal-toggle="crud-modal" class="bg-gray-200 text-green-700 group-hover:text-gray-800 group-hover:smooth-hover flex w-16 h-16 rounded-full items-center justify-center" href="#">
                        ...
                        <tbody>
                            <?php foreach ($projects as $project) : ?>
                                <tr class="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-600">
                                    <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white"><?php echo $project->getNompro(); ?></th>
                                    <td class="px-6 py-4"><?php echo $project->getDescpro(); ?></td>
                                    <td class="px-6 py-4">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-4 md:p-5">
                        <form class="space-y-4" action="" method="post">
                            ...
                            <button type="submit" name="editprojet" class="inline-flex items-center bg-green-100 hover:bg-green-200 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                <svg class="me-1 -ms-1 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" d="M10 5a1 1 0 011 1v3h3a1 1 0 110 2h-3v3a1 1 0 11-2 0v-3H6a1 1 0 110-2h3V6a1 1 0 011-1z" clip-rule="evenodd"></path>
                                </svg>
                                Update project
