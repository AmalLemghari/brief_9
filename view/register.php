    ...
    <section>
        ...
        <div class="min-h-screen bg-gray-100 py-6 flex flex-col justify-center sm:py-12" id="signform">
            <div class="relative py-3 sm:max-w-xl sm:mx-auto">
                <div class="absolute inset-0 bg-gradient-to-r from-indigo-500 to-green-500 shadow-lg transform -skew-y-6 sm:skew-y-0 sm:-rotate-6 sm:rounded-3xl">
                </div>
                        ...
                        <form action="" method="post" >
                            ...
                            <div class="divide-y divide-gray-200">
                                <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                                    ...
                                    <div class="relative">
                                        <button name="submit" type="submit" class="bg-gradient-to-r from-indigo-500 to-green-500 text-white rounded-md px-2 py-1">Create Account</button>
                                    </div>
                                    <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                                        already have an account? <a href="login.php" class="font-medium text-blue-600  hover:underline">Login to your account </a>
                                    </p>
                                </div>
                            </div>
                        </form>
